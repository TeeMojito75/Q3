...
int main(int argc, char* argv[])
{
    ...
    for (int i = 0; i < 10; ++i) kill(pid_vec[i], SIGUSR1); //Al haber cambiado el tratamiento de SIGCHLD ahora cuando hagamos kill SIGUSR1 a todos los hijos, el padre no ignorará SIGCHLD sinó que hará el tratamiento establecido anteriormente
    while (hijos > 0);
